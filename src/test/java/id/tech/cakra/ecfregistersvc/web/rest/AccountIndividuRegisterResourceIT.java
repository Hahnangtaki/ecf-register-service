...
import id.tech.cakra.ecfregistersvc.repository.AccountIndividuRegisterRepository;
import id.tech.cakra.ecfregistersvc.service.AccountIndividuRegisterService;
import id.tech.cakra.ecfregistersvc.service.dto.AccountIndividuRegisterDTO;
import id.tech.cakra.ecfregistersvc.service.mapper.AccountIndividuRegisterMapper;
...
public class AccountIndividuRegisterResourceIT {
    ...
    private static final String DEFAULT_HEIR_RELATION = "AAAAAAAAAA";
    private static final String UPDATED_HEIR_RELATION = "BBBBBBBBBB";
    ...
    public static AccountIndividuRegister createEntity(EntityManager em) {
        AccountIndividuRegister accountIndividuRegister = new AccountIndividuRegister()
            ...
            .heir(DEFAULT_HEIR)
            .heirRelation(DEFAULT_HEIR_RELATION)
    ...
    public static AccountIndividuRegister createUpdatedEntity(EntityManager em) {
        AccountIndividuRegister accountIndividuRegister = new AccountIndividuRegister()
            ...
            .heir(UPDATED_HEIR)
            .heirRelation(UPDATED_HEIR_RELATION)
    ...
    public void createAccountIndividuRegister() throws Exception {
        ...
        assertThat(testAccountIndividuRegister.getHeirRelation()).isEqualTo(DEFAULT_HEIR_RELATION);
    ...
    public void getAllAccountIndividuRegisters() throws Exception {
        ...
        restAccountIndividuRegisterMockMvc.perform(get("/api/account-individu-registers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].heirRelation").value(hasItem(DEFAULT_HEIR_RELATION)))
    ...
    public void getAccountIndividuRegister() throws Exception {
        ...
        restAccountIndividuRegisterMockMvc.perform(get("/api/account-individu-registers/{id}", accountIndividuRegister.getId()))
            ...
            .andExpect(jsonPath("$.heirRelation").value(DEFAULT_HEIR_RELATION))
    ...
    public void updateAccountIndividuRegister() throws Exception {
        ...
        assertThat(testAccountIndividuRegister.getHeirRelation()).isEqualTo(UPDATED_HEIR_RELATION);
