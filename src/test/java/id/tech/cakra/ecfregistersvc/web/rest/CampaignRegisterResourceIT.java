...
public class CampaignRegisterResourceIT {
    ...
    private static final BigDecimal DEFAULT_FUND_TARGET = new BigDecimal(1);
    private static final BigDecimal UPDATED_FUND_TARGET = new BigDecimal(2);

    private static final BigDecimal DEFAULT_FUND_RAISED = new BigDecimal(1);
    private static final BigDecimal UPDATED_FUND_RAISED = new BigDecimal(2);

    private static final BigDecimal DEFAULT_FUND_PAID = new BigDecimal(1);
    private static final BigDecimal UPDATED_FUND_PAID = new BigDecimal(2);

    private static final BigDecimal DEFAULT_QTY_TARGET = new BigDecimal(1);
    private static final BigDecimal UPDATED_QTY_TARGET = new BigDecimal(2);

    private static final BigDecimal DEFAULT_QTY_RAISED = new BigDecimal(1);
    private static final BigDecimal UPDATED_QTY_RAISED = new BigDecimal(2);

    private static final BigDecimal DEFAULT_EST_ROI_MIN = new BigDecimal(1);
    private static final BigDecimal UPDATED_EST_ROI_MIN = new BigDecimal(2);

    private static final BigDecimal DEFAULT_EST_ROI_MAX = new BigDecimal(1);
    private static final BigDecimal UPDATED_EST_ROI_MAX = new BigDecimal(2);
    ...
    public void getAllCampaignRegisters() throws Exception {
        ...
        restCampaignRegisterMockMvc.perform(get("/api/campaign-registers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fundTarget").value(hasItem(DEFAULT_FUND_TARGET.intValue())))
            .andExpect(jsonPath("$.[*].fundRaised").value(hasItem(DEFAULT_FUND_RAISED.intValue())))
            .andExpect(jsonPath("$.[*].fundPaid").value(hasItem(DEFAULT_FUND_PAID.intValue())))
            ...
            .andExpect(jsonPath("$.[*].estRoiMin").value(hasItem(DEFAULT_EST_ROI_MIN.intValue())))
            .andExpect(jsonPath("$.[*].estRoiMax").value(hasItem(DEFAULT_EST_ROI_MAX.intValue())))
    ...
    public void getCampaignRegister() throws Exception {
        ...
        restCampaignRegisterMockMvc.perform(get("/api/campaign-registers/{id}", campaignRegister.getId()))
            ...
            .andExpect(jsonPath("$.fundTarget").value(DEFAULT_FUND_TARGET.intValue()))
            .andExpect(jsonPath("$.fundRaised").value(DEFAULT_FUND_RAISED.intValue()))
            .andExpect(jsonPath("$.fundPaid").value(DEFAULT_FUND_PAID.intValue()))
            ...
            .andExpect(jsonPath("$.estRoiMin").value(DEFAULT_EST_ROI_MIN.intValue()))
            .andExpect(jsonPath("$.estRoiMax").value(DEFAULT_EST_ROI_MAX.intValue()))
