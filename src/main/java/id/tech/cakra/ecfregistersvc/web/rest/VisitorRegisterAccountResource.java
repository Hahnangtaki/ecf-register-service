...
import id.tech.cakra.ecfregistersvc.service.VisitorRegisterAccountService;
...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.VisitorRegisterAccount}.
 */
@RestController
@RequestMapping("/api")
public class VisitorRegisterAccountResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcVisitorRegisterAccount";
    ...
    public ResponseEntity<VisitorRegisterAccountDTO> updateVisitorRegisterAccount(@Valid @RequestBody VisitorRegisterAccountDTO visitorRegisterAccountDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, visitorRegisterAccountDTO.getId().toString()))
            .body(result);
    }
