...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.AccountIndividuRegister}.
 */
@RestController
@RequestMapping("/api")
public class AccountIndividuRegisterResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcAccountIndividuRegister";
    ...
    public ResponseEntity<AccountIndividuRegisterDTO> updateAccountIndividuRegister(@Valid @RequestBody AccountIndividuRegisterDTO accountIndividuRegisterDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountIndividuRegisterDTO.getId().toString()))
            .body(result);
    }
