...
import id.tech.cakra.ecfregistersvc.service.OtpHistoryService;
...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.OtpHistory}.
 */
@RestController
@RequestMapping("/api")
public class OtpHistoryResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcOtpHistory";
