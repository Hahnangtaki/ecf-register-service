...
import id.tech.cakra.ecfregistersvc.service.AccountInstitutionRegisterService;
...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.AccountInstitutionRegister}.
 */
@RestController
@RequestMapping("/api")
public class AccountInstitutionRegisterResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcAccountInstitutionRegister";
    ...
    public ResponseEntity<AccountInstitutionRegisterDTO> updateAccountInstitutionRegister(@Valid @RequestBody AccountInstitutionRegisterDTO accountInstitutionRegisterDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountInstitutionRegisterDTO.getId().toString()))
            .body(result);
    }
