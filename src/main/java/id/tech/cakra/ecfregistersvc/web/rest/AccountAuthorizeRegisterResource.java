...
import id.tech.cakra.ecfregistersvc.service.AccountAuthorizeRegisterService;
import id.tech.cakra.ecfregistersvc.web.rest.errors.BadRequestAlertException;
import id.tech.cakra.ecfregistersvc.service.dto.AccountAuthorizeRegisterDTO;
...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.AccountAuthorizeRegister}.
 */
@RestController
@RequestMapping("/api")
public class AccountAuthorizeRegisterResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcAccountAuthorizeRegister";
    ...
    public ResponseEntity<AccountAuthorizeRegisterDTO> updateAccountAuthorizeRegister(@Valid @RequestBody AccountAuthorizeRegisterDTO accountAuthorizeRegisterDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountAuthorizeRegisterDTO.getId().toString()))
            .body(result);
    }
