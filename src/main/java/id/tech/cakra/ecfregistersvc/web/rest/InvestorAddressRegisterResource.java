...
import id.tech.cakra.ecfregistersvc.service.InvestorAddressRegisterService;
import id.tech.cakra.ecfregistersvc.web.rest.errors.BadRequestAlertException;
import id.tech.cakra.ecfregistersvc.service.dto.InvestorAddressRegisterDTO;
...
/**
 * REST controller for managing {@link id.tech.cakra.ecfregistersvc.domain.InvestorAddressRegister}.
 */
@RestController
@RequestMapping("/api")
public class InvestorAddressRegisterResource {
    ...
    private static final String ENTITY_NAME = "ecfregistersvcInvestorAddressRegister";
    ...
    public ResponseEntity<InvestorAddressRegisterDTO> updateInvestorAddressRegister(@Valid @RequestBody InvestorAddressRegisterDTO investorAddressRegisterDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, investorAddressRegisterDTO.getId().toString()))
            .body(result);
    }
