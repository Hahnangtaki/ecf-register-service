...
public class AccountRegister implements Serializable {
    ...
    public AccountBankRegister getAccountBankRegister() {
        return accountBankRegister;
    }

    public AccountRegister accountBankRegister(AccountBankRegister accountBankRegister) {
        this.accountBankRegister = accountBankRegister;
        return this;
    }

    public void setAccountBankRegister(AccountBankRegister accountBankRegister) {
        this.accountBankRegister = accountBankRegister;
    }
