...
public class AccountIndividuRegister implements Serializable {
    ...
    @Size(max = 120)
    @Column(name = "heir_relation", length = 120)
    ...
    public AccountIndividuRegister heirRelation(String heirRelation) {
    ...
    public AccountIndividuRegister annualIncome(BigDecimal annualIncome) {
